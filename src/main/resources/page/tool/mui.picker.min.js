...
!(function (e, t, i, n) {
    ...
    (p.prototype.findElementItems = function () {
        var e = this;
        return (
            (e.elementItems = [].slice.call(e.holder.querySelectorAll("li"))),
                e.elementItems
        );
    }),
        (p.prototype.init = function () {
            ...
            (e.list = e.holder.querySelector("ul")),
                ...
                (e.d = 2 * e.r),
                (e.itemHeight =
                    e.elementItems.length > 0 ? e.elementItems[0].offsetHeight : s),
                (e.itemAngle = parseInt(e.calcAngle(0.8 * e.itemHeight))),
            ...
            u &&
            (e.list.style.webkitTransformOrigin = "center center " + e.r + "px");
        }),
        ...
        (p.prototype.calcElementItemVisibility = function (e) {
            ...
            t.elementItems.forEach(function (i) {
                ...
                n < t.hightlightRange
                    ...
                    : n < t.visibleRange
                    ? (i.classList.add("visible"), i.classList.remove("highlight"))
                    : (i.classList.remove("highlight"), i.classList.remove("visible"));
            });
        }),
        (p.prototype.setAngle = function (e) {
            var t = this;
            (t.list.angle = e),
                (t.list.style.webkitTransform =
                    "perspective(1000px) rotateY(0deg) rotateX(" + e + "deg)"),
            ...
            t.holder.addEventListener(
                ...
                t.list.addEventListener(
                    ...
                    function (e) {
                        ...
                        "LI" == elementItem.tagName &&
                        t.setSelectedIndex(t.elementItems.indexOf(elementItem), 200);
                    },
                    !1
                );
        }),
        ...
        (p.prototype.updateInertiaParams = function (e, t) {
            ...
            if (t)
                ...
                a - i.lastMoveTime > 300 &&
                ((i.lastMoveTime = a), (i.lastMoveStart = n.pageY));
            }
            i.stopInertiaMove = !0;
        }),
        (p.prototype.startInertiaScroll = function (e) {
            ...
            return (
                o + d < t.beginExceed &&
                ((d = t.beginExceed - o), (c = c * (d / u) * 0.6)),
                o + d > t.endExceed && ((d = t.endExceed - o), (c = c * (d / u) * 0.6)),
                    ...
                    !(function l() {
                        if (!a.stopInertiaMove) {
                            ...
                            return (
                                a.setAngle(e),
                                    c++,
                                    c > s - 1 || e < a.beginExceed || e > a.endExceed
                                        ? void a.endScroll()
                                        : void setTimeout(l, r)
                            );
                        }
        ...
        (p.prototype.triggerChange = function (t) {
            ...
            setTimeout(function () {
                ...
                !e.trigger ||
                (n == i.lastIndex && t !== !0) ||
                e.trigger(i.holder, "change", { index: n, item: a }),
                    (i.lastIndex = n),
                "function" == typeof t && t();
            }, 0);
        }),
    ...
    (function (e, t) {
        e.dom = function (i) {
            return "string" != typeof i
                ? i instanceof Array || (i[0] && i.length)
                    ? [].slice.call(i)
                    : [i]
                : (e.__create_dom_div__ ||
                (e.__create_dom_div__ = t.createElement("div")),
        ...
        e.PopPicker = e.Class.extend({
            ...
            hide: function () {
                var i = this;
                i.disposed ||
                (i.panel.classList.remove(e.className("active")),
                    i.mask.close(),
        ...
        e.DtPicker = e.Class.extend({
            ...
            getSelected: function () {
                ...
                switch (i) {
                    ...
                    case "hour":
                        (n.value =
                            n.y.value + "-" + n.m.value + "-" + n.d.value + " " + n.h.value),
                            (n.text =
                                n.y.text + "-" + n.m.text + "-" + n.d.text + " " + n.h.text);
                }
                return n;
            },
            ...
            getDayNum: function (e, t) {
                var i = this;
                return i._inArray([1, 3, 5, 7, 8, 10, 12], t)
                    ? 31
                    : i._inArray([4, 6, 9, 11], t)
                        ? 30
                        : i.isLeapYear(e)
                            ? 29
                            : 28;
            ...
            _isBeginDay: function () {
                return (
                    this._isBeginMonth() &&
                    this.options.beginDay ===
                    parseInt(this.ui.d.picker.getSelectedValue())
                );
            },
            ...
            _createMonth: function (e) {
                ...
                if (i.customData.m) a = i.customData.m;
                    ...
                    for (
                        var r = i.beginMonth && t._isBeginYear() ? i.beginMonth : 1,
                            s = i.endMonth && t._isEndYear() ? i.endMonth : 12;
                        s >= r;
                        r++
                    ) {
                        var c = t._fill(r);
            ...
            _createDay: function (e) {
                ...
                if (i.customData.d) a = i.customData.d;
                    ...
                    for (
                        var r = t._isBeginMonth() ? i.beginDay : 1,
                            s = t._isEndMonth()
                                ? i.endDay
                                : t.getDayNum(
                                    parseInt(this.ui.y.picker.getSelectedValue()),
            ...
            _createHours: function (e) {
                ...
                if (i.customData.h) a = i.customData.h;
                    ...
                    for (
                        var r = t._isBeginDay() ? i.beginHours : 0,
                            s = t._isEndDay() ? i.endHours : 23;
                        s >= r;
                        r++
                    ) {
                        var c = t._fill(r);
            ...
            _createMinutes: function (e) {
                ...
                if (i.customData.i) a = i.customData.i;
                    ...
                    for (
                        var r = t._isBeginHours() ? i.beginMinutes : 0,
                            s = t._isEndHours() ? i.endMinutes : 59;
                        s >= r;
                        r++
                    ) {
                        var c = t._fill(r);
